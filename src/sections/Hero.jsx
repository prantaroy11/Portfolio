...
structures and problem solving.
            ...
            <div className="flex flex-wrap gap-4 animate-fade-in animation-delay-300">
              ...
              <a href="https://drive.google.com/drive/folders/1GsLN_d4-VCll4LXFsfTsssfNFLEJNa5y?usp=sharing" target="_blank" >
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                { icon: Github, href: "https://github.com/prantaroy11"},
                { icon: Linkedin, href: "https://www.linkedin.com/in/pranta-roy-joy-1467742bb/" },
              ].map((social, idx) => (
                <a
                target="_blank"
                  key={idx}
